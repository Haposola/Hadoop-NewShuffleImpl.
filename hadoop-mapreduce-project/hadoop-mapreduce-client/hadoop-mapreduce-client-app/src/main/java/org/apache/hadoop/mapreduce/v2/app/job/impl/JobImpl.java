...
public class JobImpl implements org.apache.hadoop.mapreduce.v2.app.job.Job,
    ...
    StateMachineFactory<JobImpl, JobStateInternal, JobEventType, JobEvent>
            ...
            .installTopology();
    //final fields
    public final ApplicationAttemptId applicationAttemptId;
    public final TaskAttemptListener taskAttemptListener;
  ...
  */
    ...
    public static class InitTransition
        ...
        private void createReduceTasks(JobImpl job) {//TODO : TARGET, write a NewReduceTaskImpl to and build it here.
            if (job.conf.getBoolean("mapreduce.shuffle.use.new.impl", false)) {
                for (int i = 0; i < job.numReduceTasks; i++) {
                    LOG.info("new new new ");
                    TaskImpl task =
                            new NewReduceTaskImpl(job.jobId, i,
                                    job.eventHandler,
                                    job.remoteJobConfFile,
